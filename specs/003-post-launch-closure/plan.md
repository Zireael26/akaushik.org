...
| 3   | `pages/api/mcp.ts`, `lib/mcp-http.ts`                                         | new                     | Expose a raw-method-safe stateless same-origin Streamable HTTP adapter.                                             |
