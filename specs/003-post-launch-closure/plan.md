...
| ----------------------------------------------------------- | ---------- | ------ | --------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| MCP adapter diverges from client expectations               | medium     | high   | Target current stable plus explicit prior/fallback negotiation, reject unsupported batches, use protocol fixtures and a real-client endpoint probe.                   |
