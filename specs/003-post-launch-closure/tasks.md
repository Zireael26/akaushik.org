...
| --- | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ----------------------------------- | -------: | ------------------------------ |
| T1  | [x] Add current/prior/fallback MCP negotiation, transport validation, draft-safe tools, and protocol-correct errors in `lib/mcp.ts`, `lib/mcp.test.ts`, and `app/api/mcp/route.ts`.                                                                                                                                                                                                                                                                                                                                                       | —                                   |    ~3.5h | SC1                            |
...
| T6  | [x] Harden runtime and automation in `package.json`, `.nvmrc`, `pnpm-lock.yaml`, `.github/workflows/{stats,ci,e2e,lighthouse,production-smoke}.yml`, `scripts/check-production.mjs`, `public/favicon.svg`, and `public/favicon.ico`.                                                                                                                                                                                                                                                                                                      | —                                   |      ~4h | SC8, SC9, SC10                 |
