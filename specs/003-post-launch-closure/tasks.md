...
| --- | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ----------------------------------- | -------: | ------------------------------ |
| T1  | [x] Add current/prior/fallback MCP negotiation, transport validation, draft-safe tools, and protocol-correct errors in `lib/mcp.ts`, `lib/mcp.test.ts`, `lib/mcp-http.ts`, and `pages/api/mcp.ts`.                                                                                                                                                                                                                                                                                                                                          | —                                   |    ~3.5h | SC1                            |
