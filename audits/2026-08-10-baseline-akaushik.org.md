...
- generated: `2026-08-10T03:45:45Z`
- profile:   `web-static`
...
- current-tree raw findings (gating): **0**
- kept after triage: **0**
- dropped (FP): **0**
- no-llm-pass: **0** (raw scanner output, not triaged)
- historical findings (separate, non-gating): **0**
- historical dispositions: kept **0** · dropped **0** · untriaged **0**

- severity (kept + no-llm-pass): **critical**: 0 · **high**: 0 · **medium**: 0 · **low**: 0
- historical severity (kept + no-llm-pass): **critical**: 0 · **high**: 0 · **medium**: 0 · **low**: 0

Verdict: **clean current tree** — no gating findings produced by any scanner.

## Findings

_No retained findings._
