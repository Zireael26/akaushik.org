...
export const metadata: Metadata = {
  title: {
    default: 'learn.akaushik.org',
    template: '%s · learn.akaushik.org',
  },
  description: 'Private course reader',
  // The course is not finished and not public. Nothing here should be indexed,
